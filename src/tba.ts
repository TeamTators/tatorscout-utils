...
export const Match2026Schema = z.object({
	...
	score_breakdown: z.object({
		red: z.object({
			adjustPoints: z.number().int(),
			autoTowerPoints: z.number().int(),
			autoTowerRobot1: z.enum(['Level1','Level2','Level3','None']),
			autoTowerRobot2: z.enum(['Level1','Level2','Level3','None']),
			autoTowerRobot3: z.enum(['Level1','Level2','Level3','None']),
			endgameTowerPoints: z.number().int(),
			endgameTowerRobot1: z.enum(['Level1','Level2','Level3','None']),
			endgameTowerRobot2: z.enum(['Level1','Level2','Level3','None']),
			endgameTowerRobot3: z.enum(['Level1','Level2','Level3','None']),
			energizedAchieved: z.boolean(),
			foulPoints: z.number().int(),
			g206Penalty: z.boolean(),
			hubScore: z.object({
				autoCount: z.number().int(),
				autoPoints: z.number().int(),
				endgameCount: z.number().int(),
				endgamePoints: z.number().int(),
				shift1Count: z.number().int(),
				shift1Points: z.number().int(),
				shift2Count: z.number().int(),
				shift2Points: z.number().int(),
				shift3Count: z.number().int(),
				shift3Points: z.number().int(),
				shift4Count: z.number().int(),
				shift4Points: z.number().int(),
				teleopCount: z.number().int(),
				teleopPoints: z.number().int(),
				totalCount: z.number().int(),
				totalPoints: z.number().int(),
				transitionCount: z.number().int(),
				transitionPoints: z.number().int(),
			}),
			majorFoulCount: z.number().int(),
			minorFoulCount: z.number().int(),
			rp: z.number().int(),
			superchargedAchieved: z.boolean(),
			totalAutoPoints: z.number().int(),
			totalPoints: z.number().int(),
			totalTeleopPoints: z.number().int(),
			totalTowerPoints: z.number().int(),
