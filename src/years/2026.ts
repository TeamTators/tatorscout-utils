...
const actionZones2026 = {
    'Blue Zone 1': [[0.302, 0.773],
                [0.302, 0.948],
                [0.215, 0.948],
                [0.215, 0.773]],
    'Blue Zone 2': [[0.215, 0.637],
                [0.302, 0.637],
                [0.302, 0.773],
                [0.215, 0.773]],
    'Blue Zone 3': [[0.215, 0.492],
                [0.302, 0.492],
                [0.302, 0.637],
                [0.215, 0.637]],
    'Blue Zone 4': [[0.215, 0.346],
                [0.302, 0.346],
                [0.302, 0.492],
                [0.215, 0.492]],
    'Blue Zone 5': [[0.215, 0.195],
                [0.302, 0.195],
                [0.302, 0.346],
                [0.215, 0.346]],
    'Blue Zone 6': [[0.215, 0.041],
                [0.302, 0.041],
                [0.302, 0.195],
                [0.215, 0.195]],
    'Red Zone 1': [[0.769, 0.773],
                [0.769, 0.948],
                [0.695, 0.948],
                [0.695, 0.773]],
    'Red Zone 2': [[0.695, 0.637],
                [0.769, 0.637],
                [0.769, 0.773],
                [0.695, 0.773]],
    'Red Zone 3': [[0.695, 0.492],
                [0.769, 0.492],
                [0.769, 0.637],
                [0.695, 0.637]],
    'Red Zone 4': [[0.695, 0.346],
                [0.769, 0.346],
                [0.769, 0.492],
                [0.695, 0.492]],
    'Red Zone 5': [[0.695, 0.195],
                [0.769, 0.195],
                [0.769, 0.346],
                [0.695, 0.346]],
    'Red Zone 6': [[0.695, 0.041],
                [0.769, 0.041],
                [0.769, 0.195],
                [0.695, 0.195]],
    };
